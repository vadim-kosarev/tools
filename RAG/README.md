...
**2026-04-29:**
- ✅ Добавлен инструмент `find_abbreviation_expansion` для расшифровки аббревиатур
- ✅ CLI интерфейс для kb_tools.py (`list`, `help`, `run` команды)
- ✅ Поддержка цифр в аббревиатурах (AK47, T34)
- ✅ Исправление передачи user_query между узлами

**2026-04-28:**
- ✅ Упрощение графа до линейной архитектуры (без циклов)
- ✅ Добавлена самооценка агента (self_assessment)
- ✅ Retry логика для исправления ошибок парсинга JSON
- ✅ Миграция на промпты v2 с Jinja2-шаблонами
- ✅ Расширенная стратегия определения терминов (15-20 вместо 3-5)
- ✅ Score/confidence в результатах semantic_search
- ✅ Предотвращение повторных вызовов инструментов
...
✅ **Все основные скрипты проверены и работоспособны** (2026-04-29)
...
**Версия агента:** v3 (линейная архитектура)  
