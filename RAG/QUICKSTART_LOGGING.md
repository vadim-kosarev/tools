...
```bash
# PowerShell: удалитьстарше 7 дней
...
ls logs/[0-9][0-9][0-9]_*.log | head -n -100 | xargs rm
```

## 📚 Документация

- `LOGGING_SYSTEM.md` - Полное описание системы
- `LLM_REQUEST_STRUCTURE.md` - Структура секций запросов
