...
mindmap
  tools
    ...
    Обработка видео
      all_good (нарезка повторов фразы из сериала по GigaAM-v3)
    Загрузка видео
...
| Проект | Описание |
| --- | --- |
| [`all_good/`](all_good/README.md) | Нарезка повторяющейся фразы из сериала в один файл (GigaAM-v3): проход 1 — распознавание речи всех серий с точными таймстампами по VAD, проход 2 (в разработке) — поиск фразы и нарезка |
